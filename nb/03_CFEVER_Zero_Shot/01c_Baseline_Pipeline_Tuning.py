...
if __name__ == "__main__":
    ...
    splits = ["train", "dev"]
    models = {
        "extend-vocab_model-4epoch": "/users/k21190024/study/fact-checking-repos/fever/baseline/thesis/zeroshot/finetune/baseline/rte/{0}/edited_model.tar.gz",
        "keep-vocab_model-4epoch": "/users/k21190024/study/fact-checking-repos/fever/baseline/thesis/zeroshot/finetune/baseline/rte/{0}/edited_model.tar.gz"
    }
        ...
        for s in sents:
            ...
            for k, model_path in models.items():
                ...
                for split in splits:
                    ...
                    _ = subprocess.run(
                        predict_command.format(sys.executable, model_path.format(k), cur_ir, cur_labels, '{\"dataset_reader\":{\"database\":\"/users/k21190024/study/fact-checking-repos/fever/baseline/dumps/feverised-climatefever/feverised-climatefever-titleid.db\"}}').split(" "), 
